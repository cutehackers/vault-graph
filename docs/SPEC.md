...
Detailed future work and scale-up candidates are maintained in
[`docs/TODO.md`](TODO.md).

Keep `docs/SPEC.md` focused on the active product contract. When a deferred item
is accepted for implementation, promote the relevant `docs/TODO.md` entry into a
focused SPEC or implementation plan before changing code.
